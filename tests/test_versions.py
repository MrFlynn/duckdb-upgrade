...
def test_version_lookup_latest() -> None:
    ...
    tests = [
        Test(StorageVersion=0, Result=Version("0.9.2"), ShouldAssert=False),
...
def test_version_lookup_get_download_url(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    tests = [
        Test(
            ...
            Platform="linux",
            Arch="x86_64",
            Result="https://github.com/duckdb/duckdb/releases/download/v0.9.2/duckdb_cli-linux-amd64.zip",
            ShouldAssert=False,
        ),
        Test(
